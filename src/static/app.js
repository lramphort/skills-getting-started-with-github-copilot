document.addEventListener("DOMContentLoaded", () => {
  ...
  // Wrap original fetchActivities with updated version that includes delete buttons
    ...
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        const participantsList = details.participants
          .map(
            (p) =>
              `<li data-email="${p}"><span class="participant-email">${p}</span><button class="delete-btn" title="Remove participant" aria-label="Remove ${p}">✕</button></li>`
          )
          .join("");
